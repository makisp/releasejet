...
describe('formatReleaseNotes', () => {
  ...
  it('renders contributors section when contributors are present', () => {
    const data: ReleaseNotesData = {
      tagName: 'v1.0.0',
      version: '1.0.0',
      clientPrefix: null,
      ...
      contributors: [
        ...
        { username: 'nikos', profileUrl: 'https://github.com/nikos' },
      ],
    };
    ...
    expect(result).toContain('[@elena](https://github.com/elena)');
    expect(result).toContain('[@makisp](https://github.com/makisp)');
    expect(result).toContain('[@nikos](https://github.com/nikos)');
    // Contributors should appear before the footer
    const contributorsIdx = result.indexOf('#### Contributors');
    const footerIdx = result.indexOf('*Generated by');
    expect(contributorsIdx).toBeLessThan(footerIdx);
  });

  it('omits contributors section when contributors list is empty', () => {
    const data: ReleaseNotesData = {
      tagName: 'v1.0.0',
      version: '1.0.0',
      clientPrefix: null,
